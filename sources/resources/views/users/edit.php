...
<?php $__env->startSection('breadcrumbs'); ?>
    <?php echo $__env->make('components.breadcrumbs', [
        'elements' => [
            [
                'url' => action('UserController@edit', $user),
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="personal-info">
                        <tr>
                            <th><?php echo app('translator')->getFromJson('site.user.company'); ?></th>
                            <td><?php echo e($user->company->name); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->getFromJson('site.user.departments'); ?></th>
                            <td><?php echo e($user->departments()->pluck('name')->join(' ')); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->getFromJson('site.user.role'); ?></th>
                ...
                <li class="col-md-3 nav-btn">
                    <a href="#home" data-toggle="tab" class="active">
                        <div class="text-center nav-tab-button py-2">
                            ...
                            <strong><?php echo app('translator')->getFromJson('site.user.personal_data'); ?></strong>
                        </div>
                    </a>
                </li>
                    ...
                    <li class="col-md-3 nav-btn">
                        <a href="#menu2" data-toggle="tab" data-toggle="tab">
                            <div class="text-center nav-tab-button py-2">
                                ...
                                <strong><?php echo app('translator')->getFromJson('site.user.notifications'); ?></strong>
                            </div>
                        </a>
                    </li>
                <?php endif; ?>
