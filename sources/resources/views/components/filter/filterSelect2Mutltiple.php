...
<div class="select2-block <?php echo e(isset($label) ? 'form-group' : ''); ?>">
    ...
    <?php endif; ?>
    <select multiple class="form-control select2 select-filter" id="<?php echo e($_name); ?>" name="<?php echo e($_name); ?>[]" <?php echo e(isset($notSubmit) ? ' ' : 'onchange=this.form.submit()'); ?>>
        ...
        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option <?php echo e(in_array($value, ($selected ?? request()->input($_requestName, [])) ) ? 'selected': ''); ?> value="<?php echo e($value); ?>"><?php echo e($name); ?></option>
