<div class="form-group select2-block <?php echo e(isset($class) ? $class : ''); ?>">
    ...
    <?php endif; ?>
    <select class="select2 form-control <?php echo e(isset($selectClass) ? $selectClass : ''); ?> <?php echo e($errors->has($name) ? ' is-invalid' : ''); ?>"
            id="<?php echo e($name); ?>"
    ...
    >
        <?php if($prompt = isset($prompt) ? $prompt : 'Select'): ?>
        ...
        <?php if($options): ?>
            <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option  <?php if(old($name, $selected ?? null) == $value): ?> selected <?php endif; ?> value="<?php echo e($value); ?>"><?php echo e($option); ?></option>
