                ...
                <div class="col-sm-4 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <p class="">
                                <span class="d-inline">$<?php echo e($plan->price); ?></span>
                                ...
                                <ul class="list-unstyled">
                                    <?php $__currentLoopData = [
                                        ...
                                        <li><?php echo app('translator')->getFromJson('site.plan.user.'.$limit); ?>:
                                            <strong><?php echo e($plan->{$limit}?:__('site.plan.user.unlimited')); ?></strong></li>
                            ...
                            <a href="<?php echo e(action('PlanController@buyPlan', $plan)); ?>"
                               class="btn btn-primary"><?php echo app('translator')->getFromJson('site.plan.user.select'); ?></a>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <div class="col-sm-4 mb-4">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(action('PlanController@createCustomPlan')); ?>"
                           class="btn btn-primary"><?php echo app('translator')->getFromJson('site.plan.user.create_button'); ?></a>
                    </div>
                </div>
            </div>
