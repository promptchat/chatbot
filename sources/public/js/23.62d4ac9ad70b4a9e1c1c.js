...
function EditUserField(_ref) {
  ...
  var handleSubmit = function handleSubmit(values, _ref2) {
    ...
    return _helpers_client_ApiClient__WEBPACK_IMPORTED_MODULE_2__["default"].call("post", "/methods/clients/".concat(clientId), {}, (_ApiClient$call = {}, _defineProperty(_ApiClient$call, fieldName, values[fieldName]), _defineProperty(_ApiClient$call, "values", values), _ApiClient$call)).validation(function (errors, data) {
      setErrors(data);
      setSubmitting(false);
    })["catch"](function () {
      setSubmitting(false);
