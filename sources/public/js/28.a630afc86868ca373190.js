...
/*!**************************************************!*\
  !*** ./resources/js/containers/user/UserEdit.js ***!
  \**************************************************/
/*! exports provided: SCREEN_MAIN_SETTINGS, SCREEN_NOTIFICATIONS_SETTINGS, SCREEN_SETTINGS, SCREEN_DEFAULT_MESSAGE_SETTINGS, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SCREEN_SETTINGS", function() { return SCREEN_SETTINGS; });
...
/* harmony import */ var _containers_user_editComponents_ChangeOtherSettingsBlock__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/containers/user/editComponents/ChangeOtherSettingsBlock */ "./resources/js/containers/user/editComponents/ChangeOtherSettingsBlock.js");
...
var SCREEN_SETTINGS = "additional-settings";
...
function UserEdit() {
  ...
  var updateInfo = function updateInfo(data) {
    var newUser = user.set("role", data.role).set("name", data.name).set("email", data.email).set("phone", data.phone).set("image_id", data.image_id).set("image", data.image).set("departments", data.departments);
    setUser(newUser);
    ...
    switch (screen) {
      ...
      case SCREEN_SETTINGS:
        content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_containers_user_editComponents_PageLayout__WEBPACK_IMPORTED_MODULE_9__["default"], {
          ...
          setScreen: changeScreen,
          afterImageChanged: updateImage
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_containers_user_editComponents_ChangeOtherSettingsBlock__WEBPACK_IMPORTED_MODULE_8__["default"], {
          user: user,
          afterSave: updateInfo
        }));
        break;
...
/***/ "./resources/js/containers/user/editComponents/ChangeOtherSettingsBlock.js":
/*!*********************************************************************************!*\
  !*** ./resources/js/containers/user/editComponents/ChangeOtherSettingsBlock.js ***!
  \*********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ChangeOtherSettingsBlock; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _containers_user_helpers_getLoadRoleOptions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @/containers/user/helpers/getLoadRoleOptions */ "./resources/js/containers/user/helpers/getLoadRoleOptions.js");
/* harmony import */ var _hooks_useAuthUser__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @/hooks/useAuthUser */ "./resources/js/hooks/useAuthUser.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
function ChangeOtherSettingsBlock(_ref) {
  var user = _ref.user,
      afterSave = _ref.afterSave;
  var userId = user.id;
  ...
  var authUser = Object(_hooks_useAuthUser__WEBPACK_IMPORTED_MODULE_12__["default"])();
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_9__["Col"], {
    ...
    show: infoChanged,
    text: t("user.settings.departments-changed-message"),
    onConfirm: function onConfirm() {
      return setInfoChanged(false);
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_form_Form__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    renderForm: function renderForm(_ref4) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_form_TagsField__WEBPACK_IMPORTED_MODULE_7__["default"], {
        id: "departments",
        name: "departments",
        label: t("user.settings.departments-label"),
        options: companyDepartments,
        setFieldValue: setFieldValue,
        onBlur: handleBlur,
        value: values.departments,
        errors: errors
      }), user.id !== authUser.id ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_form_SelectField__WEBPACK_IMPORTED_MODULE_10__["default"], {
        className: "limiter",
        id: "role",
        label: t("user.settings.role-label"),
        name: "role",
        setFieldValue: setFieldValue,
        value: values.role,
        errors: errors,
        options: Object(_containers_user_helpers_getLoadRoleOptions__WEBPACK_IMPORTED_MODULE_11__["getRoleOptions"])(t).filter(function (role) {
          return role.value !== _models_User__WEBPACK_IMPORTED_MODULE_6__["ROLE_SYSTEM_ADMINISTRATOR"];
        }),
        isClearable: false
      }) : null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_buttons_SubmitButton__WEBPACK_IMPORTED_MODULE_5__["default"], {
        className: "pt-2 px-4 my-4",
        disabled: isSubmitting
      }, t("common.saveBtnText")));
    }
...
ChangeOtherSettingsBlock.propTypes = {
  user: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.instanceOf(_models_User__WEBPACK_IMPORTED_MODULE_6__["default"]).isRequired,
  afterSave: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func.isRequired
};
...
function PageLayout(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_2__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_2__["Col"], {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_3___default()("navigation-item rounded-top w-100 py-2 px-3", {
      active: screen === _containers_user_UserEdit__WEBPACK_IMPORTED_MODULE_4__["SCREEN_SETTINGS"]
    }),
    onClick: function onClick() {
      return setScreen(_containers_user_UserEdit__WEBPACK_IMPORTED_MODULE_4__["SCREEN_SETTINGS"]);
    }
