...
function InstantMessagesForm(_ref) {
  ...
  var onSubmit = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (values, actions) {
    var _values$template, _values$integration, _values$sentViaIntegr, _values$template2;
    ...
    var formattedValues = {
      ...
      send_via_integration_id: ((_values$sentViaIntegr = values.sentViaIntegration) === null || _values$sentViaIntegr === void 0 ? void 0 : _values$sentViaIntegr.value) || null,
    ...
    handleSubmit(formattedValues).data(function (data) {
      ...
      var formattedErrors = {
        ...
        sentViaIntegration: errors.send_via_integration_id
      };
