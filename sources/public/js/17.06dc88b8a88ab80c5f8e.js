...
var loading = function loading() {
  return {
    type: _redux_reducers_siteConfigs_actionTypes__WEBPACK_IMPORTED_MODULE_0__["default"].LOADING
  };
};

var error = function error(data) {
  return {
    type: _redux_reducers_siteConfigs_actionTypes__WEBPACK_IMPORTED_MODULE_0__["default"].LOADING_ERROR,
    payload: data
  };
};
...
var itemsListLoaded = function itemsListLoaded(data) {
  return {
    type: _redux_reducers_siteConfigs_actionTypes__WEBPACK_IMPORTED_MODULE_0__["default"].ITEMS_LOADED,
    payload: data
  };
};
