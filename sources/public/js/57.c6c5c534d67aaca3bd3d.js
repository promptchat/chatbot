...
/* harmony import */ var _containers_instantMessages_form_widgets_ClientsSelectField__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/containers/instantMessages/form/widgets/ClientsSelectField */ "./resources/js/containers/instantMessages/form/widgets/ClientsSelectField.js");
...
function EditInstantMessagePage() {
  ...
  if (data) {
    var _data$selected, _data$selected2, _data$selected3;

    var initialClients = Object(_containers_instantMessages_form_widgets_ClientsSelectField__WEBPACK_IMPORTED_MODULE_7__["formatClientsOptions"])(data.clients);
    content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_containers_instantMessages_form_InstantMessagesForm__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      fromFilters: !!((_data$selected = data.selected) === null || _data$selected === void 0 ? void 0 : _data$selected.selected),
      initialData: {
        name: data.name,
        ...
        sendViaIntegration: data.send_via_integration ? {
          label: data.send_via_integration.name,
          value: data.send_via_integration.id,
          integration: data.send_via_integration
        } : null,
        ...
        filters: ((_data$selected2 = data.selected) === null || _data$selected2 === void 0 ? void 0 : _data$selected2.filters) || {},
        selected: (_data$selected3 = data.selected) === null || _data$selected3 === void 0 ? void 0 : _data$selected3.selected,
