    ...
    renderForm: function renderForm(_ref2) {
      ...
      var handleIntegrationChange = function handleIntegrationChange(name, value) {
        ...
        if (!value) {
          ...
          _helpers_client_ApiClient__WEBPACK_IMPORTED_MODULE_6__["default"].call("get", "/methods/clients/generate-import-name/".concat(value)).data(function (_ref3) {
            var name = _ref3.name,
                code = _ref3.code;
...
function ImportCsvPage() {
  ...
  var handleSubmit = function handleSubmit(values, _ref) {
    ...
    for (var tagIndex in values.tags) {
      if (values.tags.hasOwnProperty(tagIndex)) {
        formData.set("tags[".concat(tagIndex, "]"), values.tags[tagIndex].label);
      }
    }
