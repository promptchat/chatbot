...
function EditInstantMessagePage() {
  ...
  if (data) {
    ...
    if (data.integration && +data.integration.service === _models_Integration__WEBPACK_IMPORTED_MODULE_7__["SERVICE_SMS_CHAT_ORG"]) {
      ...
      clients = Object(_containers_instantMessages_form_widgets_ClientsSelectField__WEBPACK_IMPORTED_MODULE_8__["formatClientsOptions"])(initialClients, data.integration && +data.integration.service);
    }
