...
/* harmony import */ var _containers_instantMessages_form_widgets_ClientsSelectField__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/containers/instantMessages/form/widgets/ClientsSelectField */ "./resources/js/containers/instantMessages/form/widgets/ClientsSelectField.js");
...
function InstantMessagesForm(_ref) {
  ...
  var updateClientsCount = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (integrationId, tags, sentViaIntegrationId, setClients) {
    ...
    if (fromFilters) {
      _helpers_client_ApiClient__WEBPACK_IMPORTED_MODULE_5__["default"].call("get", "/methods/instant-messages/clients-from-filters", {
        filters: JSON.stringify(initialData.filters),
        selected: JSON.stringify(initialData.selected),
        sent_via_integration_id: sentViaIntegrationId
      }).data(function (data) {
        setCalculation(false);
        setTimeout(function () {
          setClients(Object(_containers_instantMessages_form_widgets_ClientsSelectField__WEBPACK_IMPORTED_MODULE_6__["formatClientsOptions"])(data.clients));
        });
      });
    } else {
...
/* harmony import */ var _components_form_base_Errors__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @/components/form/base/Errors */ "./resources/js/components/form/base/Errors.js");
...
function InstantMessagesFormView(_ref) {
  var _errors$message, _errors$message2, _values$clients;
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, t("instantMessages.form.text-label")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: classnames__WEBPACK_IMPORTED_MODULE_20___default()({
      "is-invalid": errors && ((_errors$message = errors["message"]) === null || _errors$message === void 0 ? void 0 : _errors$message.length)
    })
  ...
  })), errors && ((_errors$message2 = errors["message"]) === null || _errors$message2 === void 0 ? void 0 : _errors$message2.length) ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_form_base_Errors__WEBPACK_IMPORTED_MODULE_19__["default"], {
    errors: errors["message"]
  }) : null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_containers_instantMessages_form_widgets_SaveTemplateModal__WEBPACK_IMPORTED_MODULE_9__["default"], {
    text: values.message,
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_form_SimpleAsyncSelectField__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/components/form/SimpleAsyncSelectField */ "./resources/js/components/form/SimpleAsyncSelectField.js");
...
var formatClientsOptions = function formatClientsOptions(options) {
  return options.map(function (option) {
    ...
    return {
      label: labelParts.join(" ") || client.name,
      value: client.id
    };
  });
};
...
function ClientsSelectField(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_form_SimpleAsyncSelectField__WEBPACK_IMPORTED_MODULE_2__["default"], {
    className: className,
    name: "clients",
