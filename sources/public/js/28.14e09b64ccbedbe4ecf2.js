...
function ClientsIndex(_ref) {
  ...
  var selectedCount = 0;
  console.log(1, selected.get("all"), 2, selected.get("list", Object(immutable__WEBPACK_IMPORTED_MODULE_28__["Map"])()).size);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_widgets_PageTitle__WEBPACK_IMPORTED_MODULE_20__["default"], null, t("clients.title")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_containers_clients_index_SearchBar__WEBPACK_IMPORTED_MODULE_17__["default"], {
    ...
    filter: Object(immutable__WEBPACK_IMPORTED_MODULE_28__["Map"])({
      display: t("tables.selected"),
      filterValue: "".concat(selectedCount)
    }),
    deleteFilter: clearSelected
    ...
    loadPage: changePage,
    route: "/clients"
  }), !!selectedCount && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_29__["Link"], {
    className: "btn btn-primary color-white px-4 pt-2 my-3 mr-2",
    to: "/instant-messages/create-from-filters?filters=".concat(JSON.stringify(filters.toJS()), "&selected=").concat(JSON.stringify(selected.toJS()))
  }, t("clients.create-instant-messenger")));
}
...
ClientsIndex.propTypes = {
  ...
  clearSelected: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func.isRequired
};
...
var dispatchToProps = function dispatchToProps(dispatch) {
  return {
    ...
    clearSelected: function clearSelected() {
      return dispatch(Object(_redux_reducers_clients_actionCreators__WEBPACK_IMPORTED_MODULE_2__["clearSelected"])());
    }
  };
};
...
/*!***************************************************************!*\
  !*** ./resources/js/redux/reducers/clients/actionCreators.js ***!
  \***************************************************************/
/*! exports provided: selectAll, selectToggle, clearSelected, loadClients */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clearSelected", function() { return clearSelected; });
...
var clearSelected = function clearSelected(id) {
  return {
    type: _redux_reducers_clients_actionTypes__WEBPACK_IMPORTED_MODULE_0__["default"].SELECT_CLEAR,
    payload: {
      id: id
    }
  };
