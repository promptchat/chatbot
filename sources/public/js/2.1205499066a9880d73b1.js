...
function withIndexPageLogic(WrappedComponent, stateToProps, dispatchToProps) {
  function WithIndexPageLogic(_ref) {
    var loadPage = _ref.loadPage,
        ...
        otherProps = _objectWithoutProperties(_ref, ["loadPage", "loading", "data", "error", "filters", "sort", "selected", "currentPage", "lastPage", "additionalPageUrlParams"]);
    ...
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
      ...
      var selected = urlSearchParams.get("selected");
      var parsedFilters = JSON.parse(filtersString) || [];
      var parsedSort = JSON.parse(sortString) || [];
      loadPage(params.page || 1, Object(immutable__WEBPACK_IMPORTED_MODULE_6__["fromJS"])(parsedFilters), Object(immutable__WEBPACK_IMPORTED_MODULE_6__["fromJS"])(parsedSort), Object(immutable__WEBPACK_IMPORTED_MODULE_6__["fromJS"])(selected));
    ...
    var changePageUrl = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (page, filters, sort) {
      var selected = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : Object(immutable__WEBPACK_IMPORTED_MODULE_6__["Map"])();
      var withoutRefresh = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
      ...
      var newUrl = path + (searchString ? "?".concat(decodeURIComponent(searchString)) : "");
      history.push(newUrl);
    }, [match, history, urlSearchParams, additionalPageUrlParams]);
    ...
    var changeSort = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (newSort) {
      changePageUrl(1, filters, newSort);
    }, [filters, changePageUrl]);
    var changePage = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (page) {
      changePageUrl(page, filters, sort);
    }, [filters, sort, changePageUrl]);
    var changeSelected = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (selected) {
      changePageUrl(currentPage, filters, sort, selected, true);
    }, [filters, sort, changePageUrl, currentPage]);
    var content;
